...
const { LineageEngine } = require('../build/lineage_udf_bundle.js');
...
// Known gaps are recorded explicitly. This prevents a misleading RESOLVED status with
// missing physical dependencies from being forgotten while allowing the golden suite
// to protect the already-correct lineage paths.
